...
function Header({ open, handleDrawer, title, ChangeFlex }) {
            ...
            <AppBar position="static" className='bg-white' >
                <Toolbar className='HeaderContent bg-white'>
                    ...
                    {/* <div
                        ...
                        // noWrap
                        // component="div"
                        className="H1 w-10 h-[10px] flex items-center justify-center"
                    >
                        <img
                            src="keeps.png"
                            id="ic1"
                            ...
                            alt="Keep Image"
                        />
                        <span id="keep" className="text-slate-700 text-xl ml-2">
                            Keep
                        </span>
                    </div> */}
