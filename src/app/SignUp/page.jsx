            ...
            <div className="mt-3">
              <form className="space-y-6" action="#" method="POST">
                  ...
                  <div className='h-auto w-full sm:w-[45%]'>
                    {/* <div className="flex  justify-start flex-col sm:flex-rol md:flex-row xl:flex-row 2xl:flex-row
                     sm:justify-between :2xl:justify-between 2xl:justify-between xl:justify-between md:justify-between ">
                      <label htmlFor="text" className="block text-sm font-medium leading-4 text-gray-900">
                        First Name
                      </label>
                    </div> */}
                    <div className="mt-2">
                ...
                <p className="mt-0 text-start text-sm text-gray-500 ">
                  <p href="#" className="text-sm leading-3 text-slate-900">
                    You can use letters, numbers & periods
                  </p>
                  <p href="#" 
                  className=" w-2/3  min-w-1/2  text-sm font-semibold leading-4 text-blue-600 hover:text-blue-900"    
                  >
