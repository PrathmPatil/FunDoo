  ...
  return (
    <><div className="flex min-h-screen  flex-1 flex-col justify-center items-center px-6 py-12 lg:px-8">
      <div className='flex flex-col'>
        <div className='  min-h-[80vh]  bg-white  min-w-[35vw] border-2 border-slate-300 rounded-md'>
          ...
          <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-sm mb-5">
            <form className="space-y-6" action="#" method="POST">
              <div>
                <div className="mt-2 xs:w-[100%]  max:sm:w-[100%]  sm:w-[90%]  md:w-[90%]  lg:w-[90%]  xl:w-[100%]     rounded-md  py-1.5 text-gray-900  ">
                  <TextField
